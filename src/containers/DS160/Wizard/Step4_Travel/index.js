...
import { Form, Button, Select, Input, Radio, Row, Col, InputNumber } from "antd";
...
class MyForm extends Component {
  ...
  onSelect = (e, field) => {
    if (field == "purpose_of_trip") {
      this.props.form.setFieldsValue({
        "data.other_purpose_of_trip": undefined,
        "data.purpose_info_type": undefined,
        "data.travel_plan.length_of_stay.length": undefined,
        "data.travel_plan.length_of_stay.period": undefined
      });
      ...
      if (field.purpose_of_trip && field.other_purpose_of_trip) {
        const purpose_info_type = constants.purpose_of_trip_advanced_specify_extra[field.purpose_of_trip][field.other_purpose_of_trip];
  ...
  render() {
    ...
    const { showPrev, showNext, data, tr, martial_status } = this.props;
        ...
        <Row gutter={16}>
          <Col xs={{ span: 24 }} sm={{ span: 12 }}>
            <Form.Item label={tr(resources.travel.purpose_of_trip.label)} extra={tr(resources.travel.purpose_of_trip.extra)}>
              ...
              })(<VisaSelect combines={constants.purpose_of_trip_advanced_options_func(tr)} onChange={e => this.onSelect(e, "purpose_of_trip")} tr={tr} />)}
            </Form.Item>
          </Col>
        </Row>
            ...
            <Col xs={{ span: 24 }} sm={{ span: 12 }}>
              <Form.Item label={tr(resources.travel.other_purpose_of_trip)}>
                {getFieldDecorator("data.other_purpose_of_trip", {
                  ...
                  rules: [{ required: true, message: tr(resources.validations.required) }]
                })(<VisaSelect combines={constants.purpose_of_trip_advanced_specify_options_func(field.purpose_of_trip, tr)} onChange={e => this.onSelect(e, "other_purpose_of_trip")} tr={tr} />)}
              </Form.Item>
            </Col>
          </Row>
        )}
