    ...
    <>
      ...
      <ul className="visa-global-ul-1">
        ...
        <li>
          <p>
            <span>
              Date delle tue ultime cinque visite o viaggi negli Stati Uniti, se hai già viaggiato negli Stati Uniti. È possibile che ti venga richiesta la cronologia dei tuoi viaggi internazionali
      ...
      <ul className="visa-global-ul-1">
        <li>
          <p>
            <span>
              Studenti e visitatori di scambio (F, J e M): ti verrà chiesto di fornire il tuo ID SEVIS, che è stampato sul tuo I-20 o DS-2019, quindi dovresti avere questo modulo disponibile al
              completamento del DS-160. Ti verrà anche chiesto di fornire l'indirizzo della scuola / programma in cui intendi studiare. Queste informazioni dovrebbero anche essere sul tuo modulo I-20
              o DS-2019.
            </span>
          </p>
        </li>
