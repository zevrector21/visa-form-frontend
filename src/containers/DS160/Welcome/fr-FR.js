...
<p>
{' '}
<span> Dates de vos cinq dernières visites ou voyages aux États-Unis, si vous avez déjà voyagé aux États-Unis. On peut également vous demander votre historique de voyages internationaux au cours des cinq dernières années. </span>
</p>
{' '}
      </li>
      <li>
...
<p>
{' '}
<span> Ce service premium de rendez-vous de visa américain vous coûtera 280 $. Cela comprend les frais MRV qui doivent être payés par le Département d'État et l'examen de la demande DS-160. </span>
{' '}
</p>
{' '}
        </li>
...
<p>
{' '}
<span> Notre agence facture 165 $ + frais gouvernementaux (de 160 $ à 265 $ selon le type de visa). </span>
{' '}
</p>
{' '}
        </li>
...
<p>
{' '}
<span> Étudiants et visiteurs d'échange (F, J et M): Il vous sera demandé de fournir votre ID SEVIS, qui est imprimé sur votre I-20 ou DS-2019, vous devriez donc l'avoir formulaire disponible lorsque vous remplissez votre DS-160. Il vous sera également demandé de fournir l'adresse de l'école / du programme dans lequel vous avez l'intention d'étudier. Ces informations doivent également figurer sur votre formulaire I-20 ou DS-2019. </span>
</p>
{' '}
      </li>
      <li>
