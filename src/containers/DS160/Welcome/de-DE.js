    ...
    <>
      ...
      <ul className="visa-global-ul-1">
        ...
        <li>
          <p>
            <span>
              Datum Ihrer letzten fünf Besuche oder Reisen in die USA, wenn Sie zuvor in die USA gereist sind. Möglicherweise werden Sie auch nach Ihrem internationalen Reiseverlauf der letzten fünf
              Jahre gefragt.
            </span>
          </p>
        </li>
      ...
      <ul className="visa-global-ul-1">
        <li>
          <p>
            <span>
              Studenten und Austauschbesucher (F, J und M): Sie werden gebeten, Ihre SEVIS-ID anzugeben, die auf Ihrer I-20 oder DS-2019 gedruckt ist. Sie sollten diese also haben Formular verfügbar,
              wenn Sie Ihren DS-160 ausfüllen. Sie werden auch gebeten, die Adresse der Schule / des Programms anzugeben, an der / dem Sie studieren möchten. Diese Informationen sollten sich auch auf
