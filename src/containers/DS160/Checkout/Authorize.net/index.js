    ...
    return (
      <Form {...formItemLayout} method="POST">
        ...
        <div className="payButtonRow">
          <Button type="primary" icon="dollar" loading={/* loading_pay */ false} style={{marginLeft: 'auto'}} onClick={(e) => this.props.placeOrder(e, this.props.form)}>PLACE ORDER</Button>
        </div>
      </Form>
...
const Form_AuthorizeNet = Form.create()(MyForm)
export default Form_AuthorizeNet