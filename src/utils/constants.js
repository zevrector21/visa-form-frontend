...
export const purpose_of_trip_advanced_options_func = (tr) => {
    return export_list(tr(purpose_of_trip_advanced_options))
}
...
export const purpose_of_trip_advanced_specify_options_func = (field, tr) => {
