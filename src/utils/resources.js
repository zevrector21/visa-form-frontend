...
const resources = {
  ...
  step_2: {
    disclaimer: {
      ...
      default: {
        en:
          'DISCLAIMER: Before you begin this application, please read carefully this disclaimer and make sure that you have a valid passport. This application will only accept the following credit cards: MasterCard, VISA and Discover (JCB, Diners Club) or bank transfer. This premium processing service of $165 offers 100% Refund Guarantee if your visa is denied. This charge does not include the Visa Fee that needs to be paid directly to the Department of State and is NON-REFUNDABLE except if your visa is denied. All information provided by you, or on your behalf by a designated third party, must be true and correct.',
        fr:
          "AVERTISSEMENT: Avant de commencer cette application, veuillez lire attentivement cet avertissement et assurez-vous d'avoir un passeport valide. Cette application accepte uniquement les cartes de crédit suivantes: MasterCard, VISA et Discover (JCB, Diners Club). Ce service de traitement Premium de $165 offre une garantie de remboursement à 100% si votre visa est refusé. Ces frais sont NON REMBOURSABLES sauf si votre visa est refusé. Toutes les informations fournies par vous ou en votre nom par un tiers désigné doivent être véridiques et correctes.",
        es:
          'DESCARGO de responsabilidad: Antes de comenzar esta aplicación, por favor lea cuidadosamente este descargo de responsabilidad y asegúrese de que usted tiene un pasaporte válido. Esta aplicación sólo se aceptan las siguientes tarjetas de crédito: MasterCard, VISA y Discover (JCB, Diners Club) o transferencia bancaria. Este servicio de procesamiento premium de $165 ofrece una garantía de reembolso del 100% si se le niega la visa. Este precio no incluye el costo de la Visa que necesita ser pagado directamente al Departamento de Estado y NO es REEMBOLSABLE, excepto si su visa es negada. Toda la información proporcionada por usted o en su nombre por un designado de terceros, debe ser verdadera y correcta.',
        de:
          'DISCLAIMER: Bevor Sie beginnen, diese Anwendung, bitte Lesen Sie sorgfältig diesen Haftungsausschluss, sowie stellen Sie sicher, dass Sie einen gültigen Reisepass. Diese Anwendung wird nur akzeptiert die folgende Kredit Karten: MasterCard, VISA und Discover (JCB, Diners Club) oder Banküberweisung. Dieser Premium-Bearbeitungsservice von 165 USD bietet eine 100% ige Rückerstattungsgarantie, wenn Ihr Visum abgelehnt wird. Diese Gebühr beinhaltet nicht die Visa-Gebühr, die bezahlt werden muss direkt an das Department of State und ist NICHT RÜCKZAHLBAR, außer wenn Ihr Visum verweigert wird. Alle Informationen, die von Ihnen oder in Ihrem Auftrag durch eine von Ihnen benannte Dritte, wahrheitsgetreu und richtig sein müssen.',
        it:
          'DISCLAIMER: Prima di iniziare questa applicazione, si prega di leggere attentamente questo disclaimer e assicurarsi che si dispone di un passaporto valido. Questa applicazione si accettano solo i seguenti carte di credito: MasterCard, VISA e Discover (JCB, Diners Club) o bonifico bancario. Questo servizio di elaborazione premium di $165 offre una garanzia di rimborso del 100% se il visto viene negato. Questo costo non include la Tassa per il Visto che deve essere pagato direttamente al Dipartimento di Stato ed è NON-RIMBORSABILE, tranne se il visto viene negato. Tutte le informazioni fornite da voi, o sul vostro conto da parte di un incaricato di terzi, devono essere veritiere e corrette.',
      },
      check: {
        en:
