  ...
  step_1: {
    section_title: {
      ...
      it:
        ...
        pr: 'Neste site, você pode se inscrever por meio de nossa agência para um Visto de Não Imigrante nos EUA. CADA VIAJANTE DEVE PREENCHER SEU PRÓPRIO FORMULÁRIO PARA OBTER SEU VISTO. O tempo médio estimado para concluir este envio é de 35 minutos por respondente.',
    },
    interview_location: {
      label: {
        ...
        pr: "Escolha o seu local preferido para a entrevista",
      },
      extra: {
        ...
        pr: "Selecione o Consulado dos EUA de sua preferência para a entrevista de visto.",
      },
    },
    privacy: {
      label: {
      ...
      extra: {
        authorities: {
          ...
          pr: "AUTORIDADES: As informações solicitadas estão de acordo com 8 U.S.C. §§ 1201-1202.",
        },
        purpose: {
          ...
          pr: "OBJETIVO: As informações solicitadas neste formulário serão usadas pelos funcionários consulares para determinar a elegibilidade do requerente para um visto.",
        },
        routine: {
          en:
          ...
          pr: "USOS DE ROTINA: As informações neste formulário podem ser compartilhadas com agências governamentais federais, estaduais e locais, membros do Congresso e funcionários de governos estrangeiros de acordo com determinados usos de rotina aprovados. Mais informações sobre os Usos de Rotina para o sistema podem ser encontradas no Sistema de Registros de Notificação Estadual-39, Registros de Visto.",
        },
        disclosure: {
          en:
          ...
          pr: "DIVULGAÇÃO: Embora o fornecimento dessas informações seja voluntário, o não fornecimento das informações solicitadas neste formulário pode resultar na incapacidade do requerente de receber um visto de imigrante ou não-imigrante.",
        },
      },
      check: {
        ...
        pr: "Eu li os termos do Aviso da Lei de Privacidade",
      },
    },
    sq_type: {
      label: {
      ...
      extra: {
        ...
        pr: "Para acessar seu aplicativo posteriormente, entretanto, você precisará: (1) seu ID de aplicativo e (2) a resposta à pergunta de segurança que você escolherá nesta página.",
      },
    },
    sq_answer: {
      label: {
  ...
  welcome: {
    how_to_apply: {
      ...
      first: {
        ...
        pr: '1. Preencha o FORMLINK Solicitação Eletrônica e efetue o pagamento.',
      },
      second: {
